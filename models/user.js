...
const userSchema = new mongoose.Schema({
  ...
  friendsEstablished: [Friend.schema], // etablierte Freundschaften
  friendRequestsPending: [Friend.schema], // erhaltene friend anfragen
  friendRequestsSent: [Friend.schema] // verschickte anfrange
});
